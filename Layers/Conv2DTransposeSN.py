...
class Conv2DTransposeSN(lr.Conv2DTranspose):

    def build(self, input_shape):

        kernalShape = self.kernel_size + (self.filters, input_shape[-1])
    ...
    def call(self, inputs, training=None):
        ...
        outHeight = conv_utils.deconv_output_length(height, kHeight, self.padding,
                                                    opHeight, sHeight)
...
if __name__ == "__main__":
    layer = Conv2DTransposeSN(64, (4, 4))
    layer.build((16,16,3))
    # layer.call([15,15,3])
